  ...
  'inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-pastel-background transition-all duration-150 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pastel-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-60',
  {
    variants: {
      variant: {
        ...
        destructive: 'bg-red-500 text-white shadow-pastel-button border border-transparent hover:bg-red-600 hover:shadow-pastel-button-hover hover:border-red-600 active:bg-red-700/90 active:shadow-pastel-button-inset active:border-red-700 transform active:scale-[0.97]',
        outline: 'border border-pastel-input-border bg-pastel-card text-pastel-text hover:bg-pastel-highlight hover:border-pastel-active-border hover:shadow-pastel-button active:bg-pastel-highlight/80 active:border-pastel-active-border/70 active:shadow-pastel-button-inset transform active:scale-[0.98]',
        ...
        ghost: 'text-pastel-text/70 border border-transparent hover:bg-pastel-highlight hover:text-pastel-text hover:border-pastel-active-border active:bg-pastel-highlight/90 active:text-pastel-primary active:border-pastel-active-border/70 transform active:scale-[0.98] shadow-none',
        ...
        tertiary: 'bg-pastel-tertiary text-pastel-tertiary-text shadow-pastel-button border border-transparent hover:bg-pastel-tertiary-hover hover:shadow-pastel-button-hover hover:border-pastel-tertiary-hover active:bg-pastel-tertiary-hover/90 active:shadow-pastel-button-inset active:border-pastel-tertiary transform active:scale-[0.97]',
        ...
        premium: 'bg-yellow-400 text-black border-yellow-600 rounded-md px-4 py-2 hover:bg-yellow-500 active:bg-yellow-600 transform active:scale-[0.97] border'
      },
      size: {
...
const Button = React.forwardRef(({ className, variant, size, asChild = false, 'data-state': dataState, ...props }, ref) => {

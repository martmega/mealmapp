      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          <Label htmlFor="servingsPerMeal" className="block text-base font-medium mb-1.5 flex items-center">
            <Users className="w-4 h-4 mr-2 text-pastel-secondary" /> Nombre de portions par repas par défaut
          </Label>
        ...
        <div className="space-y-2">
          <Label htmlFor="maxCalories" className="block text-base font-medium mb-1.5">Calories maximales par jour</Label>

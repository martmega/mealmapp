    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="max-w-3xl mx-auto bg-pastel-card p-6 sm:p-10 rounded-xl shadow-pastel-soft text-pastel-text">
        ...
        <section className="mb-6">
          ...
          <p className="mb-2">
            Nous pouvons collecter des informations vous concernant de
            différentes manières. Les informations que nous pouvons collecter
            via le Service comprennent :
          </p>
        ...
        <section className="mb-6">
          ...
          <p className="mb-2">
            Avoir des informations précises à votre sujet nous permet de vous
            fournir une expérience fluide, efficace et personnalisée. Plus
            précisément, nous pouvons utiliser les informations collectées à
            votre sujet via le Service pour :
          </p>
          <ul className="list-disc list-inside space-y-1 pl-4 mb-3">
            ...
            <li>
              Prévenir les activités frauduleuses, surveiller contre le vol et
              protéger contre les activités criminelles.
            </li>

...
import RecipeFormImageHandler from '@/components/form/RecipeFormImageHandler';
import RecipeFormAIFeatures from '@/components/form/RecipeFormAIFeatures';
import useTagHandler from '@/components/form/hooks/useTagHandler';
import useImageUpload from '@/components/form/hooks/useImageUpload';
import useRecipeAIHelpers from '@/components/form/hooks/useRecipeAIHelpers';
...
function RecipeForm({
  ...
  const {
    ...
    handleAddTag,
    handleRemoveTag,
  } = useTagHandler(formData, setFormData);
  const {
    fileInputRef,
    handleFileChange,
    uploadImage,
    ...
    previewImage,
    setPreviewImage,
  } = useImageUpload(session, setFormData);
  const { generateWithAI, isGeneratingDescription, isGeneratingImage } =
    useRecipeAIHelpers({
      session,
      isPremiumUser: userProfile?.subscription_tier === 'premium',
      onClose,
      formData,
      setFormData,
      descriptionRef,
